...
var crearPerfil = exports.crearPerfil = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee(req, res) {
    var _req$body, nombre, telefono, direccion, tipo_perfil_id, ciudad_id, creado_por_usuario_id, datos, perfilId;
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          ...
          console.error('Error al crear el perfil:', _context.t0.message);
          res.status(500).json({
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          console.error('Error al obtener los perfiles:', _context2.t0.message);
          res.status(500).json({
    ...
    return _regenerator["default"].wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 7:
          ...
          console.error('Error al obtener los perfiles:', _context3.t0.message);
          res.status(500).json({
            error: 'Error al obtener los perfiles'
          });
        case 11:
    ...
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 10:
          ...
          console.error('Error al obtener el perfil:', _context4.t0.message);
          res.status(500).json({
...
var actualizarPerfil = exports.actualizarPerfil = /*#__PURE__*/function () {
  var _ref5 = (0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee5(req, res) {
    var id, _req$body2, nombre, telefono, direccion, tipo_perfil_id, ciudad_id, usuario_id, datos, perfilActualizado;
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 11:
          ...
          console.error('Error al actualizar el perfil:', _context5.t0.message);
          res.status(500).json({
  ...
  return function actualizarPerfil(_x9, _x10) {
...
var eliminarPerfil = exports.eliminarPerfil = /*#__PURE__*/function () {
    ...
    return _regenerator["default"].wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 10:
          ...
          console.error('Error al eliminar (desactivar) el perfil:', _context6.t0.message);
          res.status(500).json({
  ...
  return function eliminarPerfil(_x11, _x12) {
