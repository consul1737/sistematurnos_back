...
import { getConsultorios, getConsultorioById, createConsultorio, updateConsultorio, deleteConsultorio, getTratamientos, getConsultoriosConTratamientos } from "@consultorios/consultorioController";
const router = Router();
